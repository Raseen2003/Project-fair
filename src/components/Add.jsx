...
const [preview,setPreview] = useState("")
  ...
  useEffect(()=>{
    if(projectDetails.projectImage.type=="image/png" || projectDetails.projectImage.type=="image/jpg" || projectDetails
      .projectImage.type=="image/jpeg"){
        ...
        <Modal.Body>
          <div className="row aign-items-center">
            <div className="col-lg-4">
                <label>
                    <input onChange={e=>setProjectDetails({...projectDetails,projectImage:e.target.files[0]})} type="file" name="" id="" style={{display:'none'}} />
                    <img className="img-fluid" src={preview?preview:uploadImg} alt="" />
                </label>
                { !uploadFileStatus && <div className="text-warning fw-bolder">*Upload Only the following file type (JPEG,JPG,PNG)</div>}
            </div>
            <div className="col-lg-8">
                ...
                <div className="mb-2">
                    <input value={projectDetails.languages} onChange={e=>setProjectDetails({...projectDetails,languages:e.target.value})} type="text" className="form-control" placeholder="Project Language" />
                </div>
                <div className="mb-2">
