...
const getHomeProjects = async ()=>{
  ...
  const handleNavigateToProject = ()=>{
    ...
    if(sessionStorage.getItem("token")){
      ...
      alert("please login to get full acess to our project collection !!!!")
    }
  }
  ...
  return (
    <>
    {/* landing page */}
      <div style={{minHeight:'100vh'}} className='d-flex className="justify-content-center align-items-center rounded shadow w-100"'>
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-6">
              <h1 style={{fontSize:'80px'}}><i class="fa-brands fa-r-project me-2"></i> 
              Project Fair
      ...
      <Card.Body>
        <Card.Text className='d-flex justify-content-center align-items-center flex-column'>
          <img width={'60px'} height={'60px'} className='rounded-circle img-fluid' src="https://www.pngitem.com/pimgs/m/78-786293_1240-x-1240-0-avatar-profile-icon-png.png" alt="" />
